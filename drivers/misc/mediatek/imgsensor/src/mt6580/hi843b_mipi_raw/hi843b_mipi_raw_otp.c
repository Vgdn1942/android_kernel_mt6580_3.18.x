...
// Bank Select 
    ...
    /*< Alvin.Shi AF otp offset begin >*/
    CAM_CALDB("[read_Hi843b_AF_Info] :hi843b_otp_data.MtkOtpData. AfMacro&AfInfinite = %d,%d\n",
        hi843b_otp_data.MtkOtpData.AfMacro,hi843b_otp_data.MtkOtpData.AfInfinite);

    temp = hi843b_otp_data.Data[17];
    hi843b_otp_data.Data[17] = hi843b_otp_data.Data[18];
    hi843b_otp_data.Data[18] = temp;

    //Read AF OTP Infinity data
    AFinf=(hi843b_otp_data.Data[18] << 8) + hi843b_otp_data.Data[17];
    CAM_CALDB("read_Hi843b_AF_Info defaulte value : AFinf=%d \n",AFinf);

    AFinf = AFinf - 50;
    CAM_CALDB("read_Hi843b_AF_Info after correct(-50) : AFinf=%d \n",AFinf);

    //Read AF OTP Macro data
    ...
    /*< Alvin.Shi AF otp macro offset 20170115 end >*/

    AFmacro = (hi843b_otp_data.Data[20] << 8) + hi843b_otp_data.Data[19];
    CAM_CALDB("read_Hi843b_AF_Info defaulte value : AFmacro=%d \n",AFmacro);
   
    AFmacro = AFmacro + 50;
    CAM_CALDB("read_Hi843b_AF_Info after correct(+50) : AFmacro=%d\n",AFmacro);
